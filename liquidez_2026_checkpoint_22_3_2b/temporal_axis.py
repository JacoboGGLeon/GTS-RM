...
class TemporalAxis:
    ...
    def to_polars(self) -> pl.DataFrame:
        # Defragment before reset_index. Upstream feature engineering may add many
        # columns incrementally; pandas then emits PerformanceWarning during
        # conversion even though the data are valid. copy() consolidates blocks
        # without changing the temporal-axis contract.
        frame = self._frame.copy().reset_index()
