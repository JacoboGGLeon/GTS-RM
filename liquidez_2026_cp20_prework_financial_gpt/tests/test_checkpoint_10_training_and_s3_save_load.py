...
class TestCheckpoint10TrainingAndS3SaveLoad(unittest.TestCase):
    ...
    def test_atomic_save_writes_success_last_and_updates_latest(self) -> None:
        ...
        prefix = "users/mi31883/financial_gpt/mlp/runs/GLOBAL_MLP_TEST001"
        expected = {
            ...
            "users/mi31883/financial_gpt/mlp/latest.json",
        }
        ...
        latest = json.loads(
            client.objects[(bucket, "users/mi31883/financial_gpt/mlp/latest.json")]
        )
    ...
    def test_loader_rejects_incomplete_or_tampered_run(self) -> None:
        ...
        bucket = "ada-us-east-1-sbx-live-mx-m6hn-data"
        prefix = "users/mi31883/financial_gpt/mlp/runs/GLOBAL_MLP_TEST003"
